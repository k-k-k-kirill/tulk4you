...
abstract class AbstractTaxonomy {
	...
	public function set_labels() {
		...
		$labels = array(
			'name'              => sprintf(
				_x( '%s', 'taxonomy general name', 'tulk4you-plugin' ),
				$this->tax_label_plural
			),
			'singular_name'     => sprintf( _x( '%s', 'taxonomy singular name', 'tulk4you-plugin' ), $this->tax_label_plural ),
			'search_items'      => sprintf( __( 'Search %s ', 'tulk4you-plugin' ), $this->tax_label_plural ),
			'all_items'         => sprintf( __( 'All %s', 'tulk4you-plugin' ), $this->tax_label_plural ),
			'parent_item'       => sprintf( __( 'Parent %s', 'tulk4you-plugin' ), $this->tax_label_plural ),
			'parent_item_colon' => sprintf( __( 'Parent %s:', 'tulk4you-plugin' ), $this->tax_label_plural ),
			'edit_item'         => sprintf( __( 'Edit %s', 'tulk4you-plugin' ), $this->tax_label_plural ),
			'update_item'       => sprintf( __( 'Update %s', 'tulk4you-plugin' ), $this->tax_label_plural ),
			'add_new_item'      => sprintf( __( 'Add New %s', 'tulk4you-plugin' ), $this->tax_label_plural ),
			'delete_item'       => sprintf( __( 'Delete %s', 'tulk4you-plugin' ), $this->tax_label_plural ),
			'new_item_name'     => sprintf( __( 'New %s', 'tulk4you-plugin' ), $this->tax_label_plural ),
		);
